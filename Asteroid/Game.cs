    ...
    static class Game
    {
        ...
        public static void Load()
        {
            ...
            for (int i = 0; i < _objects.Length; i++)
                _objects[i] = new Star(new Point(Random.Next(0, Width), Random.Next(0,Height)), new Point(-10+Random.Next(-2,2), 0), new Size(20, 20),Brushes.Blue);
        }
